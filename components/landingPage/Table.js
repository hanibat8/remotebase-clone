  ...
  return (
    ...
    <tr>
      <td className="bg-[#f4f7ff] uppercase px-8 py-4">
        <span classNameName='w-4 h-4 p-3 py-2 mr-2 rounded-full border border-spacing-1 border-violet-400'>1</span>
    ...
    <tr>
      <td className="bg-[#f4f7ff] uppercase px-8 py-4">
      <span classNameName='w-4 h-4 p-3 py-2 mr-2 rounded-full border border-spacing-1 border-violet-400'>2</span>
    ...
    <tr>
      <td className="bg-[#f4f7ff] uppercase px-8 py-4">
      <span classNameName='w-4 h-4 p-3 py-2 mr-2 rounded-full border border-spacing-1 border-violet-400'>3</span>
    ...
    <tr>
      <td className="bg-[#f4f7ff] uppercase px-8 py-4">
      <span classNameName='w-4 h-4 p-3 py-2 mr-2 rounded-full border border-spacing-1 border-violet-400'>4</span>
    ...
    <tr>
      <td className="bg-[#f4f7ff] uppercase px-8 py-4">
      <span classNameName='w-4 h-4 p-3 py-2 mr-2 rounded-full border border-spacing-1 border-violet-400'>5</span>
    ...
    <tr>
      <td className="bg-[#f4f7ff] uppercase px-8 py-4">
      <span classNameName='w-4 h-4 p-3 py-2 mr-2 rounded-full border border-spacing-1 border-violet-400'>6</span>
